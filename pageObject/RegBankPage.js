...
class RegBankPage{
    ...
    constructor(page){
        ...
        this.expectedURL = "https://uat.airgate.ng/dashboard/compliance/registered-business/document";
        this.businessNumberLocator = page.locator("#cac_number");
    ...
    async selectBank(bankName){
        await this.bankDropdownLocator.pressSequentially(bankName, { delay: 1400 });
    ...
    async assertBankFormIsSuccessful(){
        await this.businessNumberLocator.waitFor();
