...
class NGOProfilePage{

    constructor(page){
        this.page = page;
        this.complianceButton = page.locator("text=Compliance");
        this.ngoCheckBox = page.locator(".select-business-type-card-checkbox");
        ...
        this.expectedURL = "https://uat.airgate.ng/dashboard/compliance/ngo/bank";
    ...
    async clickNGOCheckBox(){
        await this.ngoCheckBox.nth(1).click();
    }
